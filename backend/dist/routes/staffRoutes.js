...
router.post('/', authMiddleware_1.requireAdmin, multer_1.uploadSingleProfileImage, staffController_1.createStaff);
router.put('/:id', authMiddleware_1.requireAdmin, multer_1.uploadSingleProfileImage, staffController_1.updateStaff);
