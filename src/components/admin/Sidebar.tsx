...
const menuModel = [
    ...
    { label: "Cari Hesaplar", icon: "pi pi-credit-card", url: "/admin/cari" },
];
            ...
            <div className="flex flex-col bg-gray-50">
                ...
                <div className="flex items-center justify-between border-b border-blue-200 px-4 py-4 md:px-6 bg-white sticky top-0 z-10 shadow-sm">
                    <div className="flex items-center gap-3">
                        <span className="font-bold text-blue-800 text-lg">Emlak Yönetim</span>
                    </div>
                    <div className="text-sm text-blue-600 font-medium">Gayrimenkul Sistemi</div>
                </div>
